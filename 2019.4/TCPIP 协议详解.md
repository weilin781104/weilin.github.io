...
![](assets\20190427214850.jpg)

# **一、 计算机网络体系结构分层**

![](assets\20190427215108.png)

计算机网络体系结构分层

![](assets\20190427215209.jpg)
...
![img](assets\20190427220853.jpg)

![img](assets\20190427220932.jpg)
...
![img](assets\20190427221959.jpg)

序列号和确认应答

### 3.4 重发超时的确定重发超时是指在重发数据之前，等待确认应答到来的那个特定时间间隔。如果超过这个时间仍未收到确认应答，发送端将进行数据重发。最理想的是，找到一个最小时间，它能保证“确认应答一定能在这个时间内返回”。
...
![img](assets\20190427223939.jpg)

夹着 IPv4 网络的两个 IPv6 网络如上图的网络环境中，网络 A 与网络 B 之间无法直接进行通信，为了让它们之间正常通信，这时必须得采用 IP 隧道的功能。
